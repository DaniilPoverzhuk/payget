<template>
  <!-- <div
    ...
    class="backdrop_active fixed inset-0 bg-popup bg-opacity-75 z-100"
  />
  <div
    v-if="visible"
    ref="dialog"
    class="z-200 fixed inset-0 p-5 flex justify-center items-center overflow-auto "
    :class="dialogClasses"
  ...
  >
    <div
      ...
      class="bg-white dark:bg-dark-c-white lg:p-6 xs:px-4 xs:py-5 shadow-xl rounded relative"
      :class="classCustom"
    >
      <div
        v-if="isIcon"
